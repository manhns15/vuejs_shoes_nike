    ...
    <section>
      <div class="container">
        <div class="row">
          ...
          <div
            class="col-md-6 col-sm-12 col-xs-12  wrapbox-content-page-contact"
          >
            ...
            <div class="box-info-contact">
              <ul class="list-info">
                <li>
                  ...
                  <p><strong>Khu 6-Lam Sơn, Thọ Xuân, Thanh Hóa</strong></p>
                </li>
                <li>
                  <p>Email chúng tôi</p>
                  <p><strong>nikeshoes@gmail.com</strong></p>
                </li>
                <li>
                  <p>Điện thoại</p>
                ...
                <li>
                  ...
                  <p>
                    <strong
                      >Thứ 2 đến Thứ 6 từ 8h đến 18h; Thứ 7 và Chủ nhật từ 9h30
                      đến 17h00
                    </strong>
                  </p>
                </li>
